---
article_id: PHN-08-01
title: "Fire-Resistant Bukan Fireproof: Istilah Keselamatan Panel"
slug: "fire-resistant-bukan-fireproof"
description: "Distinguish combustible/noncombustible language, reaction to fire, fire resistance, ignition/spread, smoke, droplets, toxicity, product, and assembly"
status: outline
publication_date: "2026-02-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-08
primary_intent: "Correct unsafe fire terminology"
reader_community: "Phenolic.id"
reader_address: "Sobat Phenolic.id"
final_route: "/artikel/fire-resistant-bukan-fireproof.html"
...
# Fire-Resistant Bukan Fireproof: Istilah Keselamatan Panel

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Fire-Resistant Bukan Fireproof: Istilah Keselamatan Panel”
- **Reader and situation:** Buyer reading “tahan api” claims
- **Reader outcome:** Distinguish combustible/noncombustible language, reaction to fire, fire resistance, ignition/spread, smoke, droplets, toxicity, product, and assembly
- **Primary intent:** Correct unsafe fire terminology
...
- **Scope boundary:** Does not classify any product; /fire-resistant/ owns sale and PHN-08-02 owns certificate review
- **Final public route:** `/artikel/fire-resistant-bukan-fireproof.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Fire-Resistant Bukan Fireproof: Istilah Keselamatan Panel**.
...
- **Exact Markdown to insert:** `![Ilustrasi Fire Resistant Phenolic Board](/wp-content/uploads/2024/11/Fire-Resistant-Phenolic-Board.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Fire Resistant Phenolic Board` as relevant content media; no pixels were inspected.
...
- `/fire-resistant` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/fire-resistant/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `PHN-08-02` → `/artikel/membaca-laporan-uji-api-phenolic.html` — Cara Membaca Test Report dan Classification Report Panel Phenolic
- `PHN-08-03` → `/artikel/produk-vs-sistem-fire-rated.html` — Product Fire Class Tidak Otomatis Menjadi Fire-Rated Wall
...
- **Tie back to this article:** Keep the explanation specific to “Fire-Resistant Bukan Fireproof: Istilah Keselamatan Panel”.
