---
article_id: PHN-08-04
title: "Smoke, Flaming Droplets, dan Toxicity: Klaim yang Tidak Boleh Dicampur"
slug: "asap-droplet-toksisitas-panel-phenolic"
description: "Explain what each metric addresses, test/report scope, ventilation and scenario limits, and what missing evidence means"
status: outline
publication_date: "2026-02-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-08
primary_intent: "Separate fire hazard metrics"
reader_community: "Phenolic.id"
reader_address: "Kawan Phenolic.id"
final_route: "/artikel/asap-droplet-toksisitas-panel-phenolic.html"
...
# Smoke, Flaming Droplets, dan Toxicity: Klaim yang Tidak Boleh Dicampur

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Smoke, Flaming Droplets, dan Toxicity: Klaim yang Tidak Boleh Dicampur”
- **Reader and situation:** Safety reviewer evaluating occupant/material risk
- **Reader outcome:** Explain what each metric addresses, test/report scope, ventilation and scenario limits, and what missing evidence means
- **Primary intent:** Separate fire hazard metrics
...
- **Scope boundary:** Does not infer toxicity or life safety from a reaction-to-fire class
- **Final public route:** `/artikel/asap-droplet-toksisitas-panel-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Smoke, Flaming Droplets, dan Toxicity: Klaim yang Tidak Boleh Dicampur**.
...
- **Tie back to this article:** Keep the explanation specific to “Smoke, Flaming Droplets, dan Toxicity: Klaim yang Tidak Boleh Dicampur”.
