---
article_id: PHN-13-04
title: "Retak, Chipping, Lubang Longgar, dan Hardware Lepas"
slug: "kerusakan-fisik-panel-phenolic"
description: "Map crack/chip/fixing symptoms to impact, cutout, support, movement, installation, corrosion, and load evidence; set isolation/escalation"
status: outline
publication_date: "2026-06-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-13
primary_intent: "Triage local mechanical damage"
reader_community: "Phenolic.id"
reader_address: "Teman Phenolic.id"
final_route: "/artikel/kerusakan-fisik-panel-phenolic.html"
...
# Retak, Chipping, Lubang Longgar, dan Hardware Lepas

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Retak, Chipping, Lubang Longgar, dan Hardware Lepas”
- **Reader and situation:** Maintainer finding cracked edges or loose fittings
- **Reader outcome:** Map crack/chip/fixing symptoms to impact, cutout, support, movement, installation, corrosion, and load evidence; set isolation/escalation
- **Primary intent:** Triage local mechanical damage
...
- **Scope boundary:** No patch, redrill, or reuse approval; PHN-10-04 and PHN-13-05 own redesign/intervention
- **Final public route:** `/artikel/kerusakan-fisik-panel-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Retak, Chipping, Lubang Longgar, dan Hardware Lepas**.
...
- `PHN-13-03` → `/artikel/diagnosis-delaminasi-phenolic-board.html` — Panel Phenolic Menggelembung, Delaminasi, atau Swelling
- `PHN-13-05` → `/artikel/repair-atau-ganti-panel-phenolic.html` — Repair, Reface, atau Ganti Panel Phenolic?
- `PHN-13-06` → `/artikel/diagnosis-tampilan-panel-phenolic.html` — Fading, Chalking, Gores, dan Perubahan Gloss
...
- **Tie back to this article:** Keep the explanation specific to “Retak, Chipping, Lubang Longgar, dan Hardware Lepas”.
