---
article_id: PHN-01-02
title: "Apa Itu Phenolic Board? Resin, Core, Face, dan Edge"
slug: "anatomi-phenolic-board"
description: "Identify resin, paper or veneer core, decorative/protective faces, edge, thickness, and how construction changes behavior"
status: outline
...
final_route: "/artikel/anatomi-phenolic-board.html"
...
# Apa Itu Phenolic Board? Resin, Core, Face, dan Edge

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Apa Itu Phenolic Board? Resin, Core, Face, dan Edge”
- **Reader and situation:** Beginner comparing sheets that look alike
- **Reader outcome:** Identify resin, paper or veneer core, decorative/protective faces, edge, thickness, and how construction changes behavior
...
- **Scope boundary:** Does not assign universal properties; PHN-02-01 owns evidence interpretation
- **Final public route:** `/artikel/anatomi-phenolic-board.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Apa Itu Phenolic Board? Resin, Core, Face, dan Edge**.
...
- **Tie back to this article:** Keep the explanation specific to “Apa Itu Phenolic Board? Resin, Core, Face, dan Edge”.
