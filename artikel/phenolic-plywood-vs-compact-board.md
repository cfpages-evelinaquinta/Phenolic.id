---
article_id: PHN-01-04
title: "Phenolic Plywood dan Compact Board: Core Berbeda, Perilaku Berbeda"
slug: "phenolic-plywood-vs-compact-board"
description: "Compare construction, weight, edges, moisture response, machining, fixing, applications, and evidence needs"
status: outline
publication_date: "2025-09-10"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-01
primary_intent: "Compare two major panel families"
reader_community: "Phenolic.id"
reader_address: "Teman Phenolic.id"
final_route: "/artikel/phenolic-plywood-vs-compact-board.html"
...
# Phenolic Plywood dan Compact Board: Core Berbeda, Perilaku Berbeda

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Phenolic Plywood dan Compact Board: Core Berbeda, Perilaku Berbeda”
- **Reader and situation:** Buyer choosing between plywood-core and paper-core products
- **Reader outcome:** Compare construction, weight, edges, moisture response, machining, fixing, applications, and evidence needs
- **Primary intent:** Compare two major panel families
...
- **Scope boundary:** Does not declare a winner or structural capacity; PHN-05 and PHN-04 own application detail
- **Final public route:** `/artikel/phenolic-plywood-vs-compact-board.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Phenolic Plywood dan Compact Board: Core Berbeda, Perilaku Berbeda**.
...
- `PHN-01-03` → `/artikel/compact-laminate-hpl-phenolic-board.html` — Compact Laminate, HPL, dan Phenolic Board: Jangan Tertukar
- `PHN-01-05` → `/artikel/cara-kerja-resin-phenolic.html` — Mengapa Resin Phenolic Menjadi Thermoset?
- `PHN-01-06` → `/artikel/kamus-istilah-papan-phenolic.html` — Istilah Papan Phenolic di Indonesia: Kamus untuk Spesifikasi dan Penawaran
...
- **Tie back to this article:** Keep the explanation specific to “Phenolic Plywood dan Compact Board: Core Berbeda, Perilaku Berbeda”.
