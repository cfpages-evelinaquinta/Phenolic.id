---
article_id: PHN-04-03
title: "Layout, Privacy, dan Accessibility pada Toilet Cubicle"
slug: "layout-toilet-cubicle-phenolic"
description: "Address clearances, door behavior, privacy gaps, accessible compartments, circulation, accessories, cleaning, and operator needs"
status: outline
publication_date: "2025-11-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-04
primary_intent: "Coordinate user-space requirements"
reader_community: "Phenolic.id"
reader_address: "Sobat Phenolic.id"
final_route: "/artikel/layout-toilet-cubicle-phenolic.html"
...
# Layout, Privacy, dan Accessibility pada Toilet Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Layout, Privacy, dan Accessibility pada Toilet Cubicle”
- **Reader and situation:** Architect planning public/commercial toilets
- **Reader outcome:** Address clearances, door behavior, privacy gaps, accessible compartments, circulation, accessories, cleaning, and operator needs
- **Primary intent:** Coordinate user-space requirements
...
- **Scope boundary:** No universal dimensions; current project/accessibility requirements govern
- **Final public route:** `/artikel/layout-toilet-cubicle-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Layout, Privacy, dan Accessibility pada Toilet Cubicle**.
...
- `PHN-04-01` → `/artikel/sistem-toilet-cubicle-phenolic.html` — Sistem Toilet Cubicle Phenolic: Panel Hanya Salah Satu Komponen
- `PHN-04-02` → `/artikel/survey-toilet-partisi-phenolic.html` — Survey Toilet untuk Partisi Phenolic
- `PHN-04-04` → `/artikel/hardware-toilet-phenolic.html` — Hardware Toilet Phenolic: Engsel, Lock, Kaki, dan Headrail
- `PHN-04-05` → `/artikel/edge-cutout-compact-board.html` — Edge dan Cutout Compact Board di Area Basah
...
- **Tie back to this article:** Keep the explanation specific to “Layout, Privacy, dan Accessibility pada Toilet Cubicle”.
