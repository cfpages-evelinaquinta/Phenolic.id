---
article_id: PHN-08-03
title: "Product Fire Class Tidak Otomatis Menjadi Fire-Rated Wall"
slug: "produk-vs-sistem-fire-rated"
description: "Explain substrates, cavities, insulation, membranes, subframes, fixings, joints, penetrations, barriers, and tested assembly boundaries"
status: outline
publication_date: "2026-02-14"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-08
primary_intent: "Distinguish product and assembly performance"
reader_community: "Phenolic.id"
reader_address: "Teman Phenolic.id"
final_route: "/artikel/produk-vs-sistem-fire-rated.html"
...
# Product Fire Class Tidak Otomatis Menjadi Fire-Rated Wall

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Product Fire Class Tidak Otomatis Menjadi Fire-Rated Wall”
- **Reader and situation:** Designer specifying wall, cubicle, or façade systems
- **Reader outcome:** Explain substrates, cavities, insulation, membranes, subframes, fixings, joints, penetrations, barriers, and tested assembly boundaries
- **Primary intent:** Distinguish product and assembly performance
...
- **Scope boundary:** No wall/façade rating or code compliance without applicable assembly evidence
- **Final public route:** `/artikel/produk-vs-sistem-fire-rated.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Product Fire Class Tidak Otomatis Menjadi Fire-Rated Wall**.
...
- `PHN-08-01` → `/artikel/fire-resistant-bukan-fireproof.html` — Fire-Resistant Bukan Fireproof: Istilah Keselamatan Panel
...
- `PHN-08-04` → `/artikel/asap-droplet-toksisitas-panel-phenolic.html` — Smoke, Flaming Droplets, dan Toxicity: Klaim yang Tidak Boleh Dicampur
- `PHN-08-05` → `/artikel/substitusi-panel-sistem-tahan-api.html` — Substitusi Panel pada Sistem Fire-Rated: Data Sebelum Approval
...
- **Tie back to this article:** Keep the explanation specific to “Product Fire Class Tidak Otomatis Menjadi Fire-Rated Wall”.
