...
- **Exact Markdown to insert:** `![Ilustrasi Panel Dinding Eksterior Phenolic](/wp-content/uploads/2024/11/Panel-Dinding-Eksterior-Phenolic.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Panel Dinding Eksterior Phenolic` as relevant content media; no pixels were inspected.
