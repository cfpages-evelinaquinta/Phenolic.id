---
article_id: PHN-03-03
title: "Survey Existing untuk Retrofit Panel Phenolic"
slug: "survey-retrofit-panel-phenolic"
description: "Record substrate, moisture, movement, geometry, services, fire boundaries, access, contamination, occupancy, and hidden-condition risks"
status: outline
publication_date: "2025-10-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-03
primary_intent: "Investigate an existing site"
reader_community: "Phenolic.id"
reader_address: "Sobat Phenolic.id"
final_route: "/artikel/survey-retrofit-panel-phenolic.html"
...
# Survey Existing untuk Retrofit Panel Phenolic

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survey Existing untuk Retrofit Panel Phenolic”
- **Reader and situation:** Renovation team replacing another lining/partition
- **Reader outcome:** Record substrate, moisture, movement, geometry, services, fire boundaries, access, contamination, occupancy, and hidden-condition risks
- **Primary intent:** Investigate an existing site
...
- **Scope boundary:** Visual survey cannot certify substrate capacity, hazardous-material absence, or code compliance
- **Final public route:** `/artikel/survey-retrofit-panel-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survey Existing untuk Retrofit Panel Phenolic**.
...
- `PHN-03-01` → `/artikel/checklist-design-brief-panel-phenolic.html` — Checklist Design Brief untuk Panel Phenolic
- `PHN-03-02` → `/artikel/memilih-jenis-phenolic-board.html` — Cara Memilih Jenis Phenolic Board Berdasarkan Aplikasi
- `PHN-03-04` → `/artikel/batas-penggunaan-phenolic-board.html` — Kapan Phenolic Board Bukan Pilihan yang Tepat?
...
- **Tie back to this article:** Keep the explanation specific to “Survey Existing untuk Retrofit Panel Phenolic”.
