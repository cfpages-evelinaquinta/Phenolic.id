---
article_id: PHN-07-04
title: "Open Joint, Drainage, dan Ventilasi di Belakang Panel Phenolic"
slug: "joint-drainase-fasad-phenolic"
description: "Explain rain entry, pressure moderation, drainage path, cavity ventilation, insects/debris, interfaces, staining, and inspection access"
status: outline
publication_date: "2026-01-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-07
primary_intent: "Detail moisture management"
reader_community: "Phenolic.id"
reader_address: "Sobat Phenolic.id"
final_route: "/artikel/joint-drainase-fasad-phenolic.html"
...
# Open Joint, Drainage, dan Ventilasi di Belakang Panel Phenolic

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Open Joint, Drainage, dan Ventilasi di Belakang Panel Phenolic”
- **Reader and situation:** Designer planning a ventilated façade
- **Reader outcome:** Explain rain entry, pressure moderation, drainage path, cavity ventilation, insects/debris, interfaces, staining, and inspection access
- **Primary intent:** Detail moisture management
...
- **Scope boundary:** No universal joint/cavity dimension or weatherproof guarantee; tested/project system governs
- **Final public route:** `/artikel/joint-drainase-fasad-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Open Joint, Drainage, dan Ventilasi di Belakang Panel Phenolic**.
...
- `PHN-07-05` → `/artikel/perubahan-warna-panel-phenolic-exterior.html` — UV, Fading, Chalking, dan Perubahan Tampilan Panel Exterior
- `PHN-07-06` → `/artikel/phenolic-board-signage-furnitur-outdoor.html` — Signage dan Furnitur Outdoor dari Phenolic Board: Batas Aplikasinya
...
- **Tie back to this article:** Keep the explanation specific to “Open Joint, Drainage, dan Ventilasi di Belakang Panel Phenolic”.
