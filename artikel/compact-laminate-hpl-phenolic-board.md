---
article_id: PHN-01-03
title: "Compact Laminate, HPL, dan Phenolic Board: Jangan Tertukar"
slug: "compact-laminate-hpl-phenolic-board"
description: "Distinguish sheet laminate, compact/self-supporting panel, bonded assembly, and generic trade labels by physical construction"
status: outline
publication_date: "2025-09-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-01
primary_intent: "Resolve trade-name confusion"
reader_community: "Phenolic.id"
reader_address: "Sobat Phenolic.id"
final_route: "/artikel/compact-laminate-hpl-phenolic-board.html"
...
# Compact Laminate, HPL, dan Phenolic Board: Jangan Tertukar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Compact Laminate, HPL, dan Phenolic Board: Jangan Tertukar”
- **Reader and situation:** Designer reading inconsistent catalogs
- **Reader outcome:** Distinguish sheet laminate, compact/self-supporting panel, bonded assembly, and generic trade labels by physical construction
- **Primary intent:** Resolve trade-name confusion
...
- **Scope boundary:** Does not decide application suitability; PHN-03-02 owns comparison
- **Final public route:** `/artikel/compact-laminate-hpl-phenolic-board.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Compact Laminate, HPL, dan Phenolic Board: Jangan Tertukar**.
...
- **Exact Markdown to insert:** `![Ilustrasi Laminate Phenolic Board](/wp-content/uploads/2024/11/Laminate-Phenolic-Board.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Laminate Phenolic Board` as relevant content media; no pixels were inspected.
...
- `PHN-01-01` → `/artikel/panduan-material-phenolic.html` — Panduan Material Phenolic: Nama, Struktur, dan Jalur Pemilihannya
- `PHN-01-02` → `/artikel/anatomi-phenolic-board.html` — Apa Itu Phenolic Board? Resin, Core, Face, dan Edge
- `PHN-01-04` → `/artikel/phenolic-plywood-vs-compact-board.html` — Phenolic Plywood dan Compact Board: Core Berbeda, Perilaku Berbeda
- `PHN-01-05` → `/artikel/cara-kerja-resin-phenolic.html` — Mengapa Resin Phenolic Menjadi Thermoset?
...
- **Tie back to this article:** Keep the explanation specific to “Compact Laminate, HPL, dan Phenolic Board: Jangan Tertukar”.
