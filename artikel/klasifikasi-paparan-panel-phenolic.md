---
article_id: PHN-03-05
title: "Interior, Semi-Exterior, dan Exterior: Menetapkan Exposure Class Proyek"
slug: "klasifikasi-paparan-panel-phenolic"
description: "Map rain, UV, humidity, temperature, pollutants, wet cleaning, shelter, orientation, edges, and maintenance to evidence requests"
status: outline
publication_date: "2025-10-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-03
primary_intent: "Define actual exposure"
reader_community: "Phenolic.id"
reader_address: "Teman Phenolic.id"
final_route: "/artikel/klasifikasi-paparan-panel-phenolic.html"
...
# Interior, Semi-Exterior, dan Exterior: Menetapkan Exposure Class Proyek

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Interior, Semi-Exterior, dan Exterior: Menetapkan Exposure Class Proyek”
- **Reader and situation:** Designer resolving ambiguous “outdoor” language
- **Reader outcome:** Map rain, UV, humidity, temperature, pollutants, wet cleaning, shelter, orientation, edges, and maintenance to evidence requests
- **Primary intent:** Define actual exposure
...
- **Scope boundary:** No invented exposure class or warranty; PHN-07 owns exterior system design
- **Final public route:** `/artikel/klasifikasi-paparan-panel-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Interior, Semi-Exterior, dan Exterior: Menetapkan Exposure Class Proyek**.
...
- **Tie back to this article:** Keep the explanation specific to “Interior, Semi-Exterior, dan Exterior: Menetapkan Exposure Class Proyek”.
