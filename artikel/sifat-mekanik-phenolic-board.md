---
article_id: PHN-02-04
title: "Kekuatan, Kekakuan, Impact, dan Abrasion pada Papan Phenolic"
slug: "sifat-mekanik-phenolic-board"
description: "Explain bending, stiffness, impact, indentation, wear, direction, supports, conditioning, and why tests are not interchangeable"
status: outline
publication_date: "2025-10-04"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PHN-02
primary_intent: "Distinguish mechanical properties"
reader_community: "Phenolic.id"
reader_address: "Sobat Phenolic.id"
final_route: "/artikel/sifat-mekanik-phenolic-board.html"
...
# Kekuatan, Kekakuan, Impact, dan Abrasion pada Papan Phenolic

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kekuatan, Kekakuan, Impact, dan Abrasion pada Papan Phenolic”
- **Reader and situation:** Specifier seeing one “strong” claim
- **Reader outcome:** Explain bending, stiffness, impact, indentation, wear, direction, supports, conditioning, and why tests are not interchangeable
- **Primary intent:** Distinguish mechanical properties
...
- **Scope boundary:** No structural span/capacity values; PHN-10-01 owns engineered support
- **Final public route:** `/artikel/sifat-mekanik-phenolic-board.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kekuatan, Kekakuan, Impact, dan Abrasion pada Papan Phenolic**.
...
- **Exact Markdown to insert:** `![Ilustrasi produk papan phenolic](/wp-content/uploads/2024/10/produk-papan-phenolic.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `produk papan phenolic` as relevant content media; no pixels were inspected.
...
- `/phenolic-board-wonosobo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `PHN-02-02` → `/artikel/berat-dan-ketebalan-phenolic-board.html` — Ketebalan, Density, dan Berat Phenolic Board
- `PHN-02-03` → `/artikel/tahan-air-vs-tahan-lembap-phenolic.html` — Tahan Air atau Tahan Lembap? Membaca Klaim Panel Phenolic
- `PHN-02-05` → `/artikel/membaca-chemical-resistance-phenolic.html` — Chemical Resistance Phenolic Board: Konsentrasi, Waktu, dan Suhu Penting
- `PHN-02-06` → `/artikel/bukti-uji-produk-dan-sistem-phenolic.html` — Product Test, System Test, dan Sertifikat: Bukti yang Mana Berlaku?
...
- **Tie back to this article:** Keep the explanation specific to “Kekuatan, Kekakuan, Impact, dan Abrasion pada Papan Phenolic”.
